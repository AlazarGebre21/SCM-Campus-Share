# Configuration Item Register for Baseline 3
...
This register documents all Configuration Items at Baseline 3, providing a snapshot of the project's configuration state after incorporating UI updates from CR-006.
...
| DOC-002 | Project README                                | /README.md                         | Project overview, installation, and usage guidelines.     | Version 1.0 established December 22, 2025; Version 1.2 updated January 03, 2026 with UI redesign screenshots | Active |
...
| SRC-042 | HTML Entry Point                         | /index.html                                  | Main HTML template for React app.              | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-043 | React Root                               | /src/main.jsx                                | Renders React app and providers.               | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-044 | Main Router                              | /src/App.jsx                                 | Defines app routes.                            | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
...
| SRC-050 | Authentication Context                   | /src/features/auth/AuthContext.jsx           | Manages auth state.                            | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-051 | Protected Route Component                | /src/features/auth/ProtectedRoute.jsx        | Guards routes by auth.                         | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-052 | Application Layout                       | /src/layouts/AppLayout.jsx                   | Main app layout.                               | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-053 | Landing Page                             | /src/features/landing/LandingPage.jsx        | Public home page.                              | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-054 | Dashboard Page                           | /src/pages/Dashboard.jsx                     | User dashboard.                                | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-055 | Upload Resource Page                     | /src/pages/UploadResource.jsx                | Resource upload page.                          | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-056 | Resource Details Page                    | /src/pages/ResourceDetails.jsx               | Resource detail view.                          | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-057 | User Profile Page                        | /src/pages/Profile.jsx                       | Profile management.                            | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-058 | Admin Dashboard Page                     | /src/pages/admin/AdminDashboard.jsx          | Admin moderation dashboard.                    | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-059 | Star Rating Component                    | /src/components/StarRating.jsx               | Rating display/submit.                         | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-060 | Comment Section Component                | /src/features/social/CommentSection.jsx      | Comment display/add.                           | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-061 | Resource Card Component                  | /src/features/resources/ResourceCard.jsx     | Resource summary card.                         | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
| SRC-062 | Logo Asset                               | /public/campus-share.svg                     | Platform logo image.                           | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign   | Active |
...
| CFG-007 | Tailwind Entry CSS                 | /src/index.css  | Tailwind CSS imports.                | Version 1.1; Version 1.2 updated January 03, 2026 with UI redesign | Active |
...
| ID      | Name                                        | Location                                | Short Description          | Version History                                                                      | Status  |
| ------- | ------------------------------------------- | --------------------------------------- | -------------------------- | ------------------------------------------------------------------------------------ | ------- |
| SCM-001 | Configuration Item Register (This Document) | /docs/CI_IDENTIFICATION_AND_REGISTER.md | Authoritative CI catalog.  | Version 3.0 established January 03, 2026 for BL3                                     | Active  |
| SCM-002 | Change Log                                  | /docs/CHANGE_LOG.md                     | Record of all changes.     | Maintained continuously from December 22, 2025; updated January 03, 2026 with CR-006 | Active  |
| SCM-003 | Baseline Records                            | /docs/baselines/ directory              | Baseline documentation.    | Created at baselines; BL3 January 03, 2026                                           | Active  |
